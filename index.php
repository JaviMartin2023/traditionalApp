...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <a class="navbar-brand" href="./">FJMM</a>
        ...
        <main role="main">
            <div class="jumbotron">
                <div class="container">
                    <h4 class="display-4">Pokemon Database</h4>
                </div>
            </div>
            <div class="container">
                <?php
                ...
                ?>
                <div class="row">
                    <h3>Look our pokemon database. Log in to edit.</h3>
                </div>
                <div class="row">
                    <?php
        ...
        <footer class="container">
            <p>&copy; Francisco Javier Martín Mariscal 2024</p>
        </footer>
